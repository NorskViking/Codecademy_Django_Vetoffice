...
def create_owner(ownerID, first_name, last_name, phone):
    """
    Create an Owner instance with given OwnerID, first and last name and phone
    """
    return Owner.objects.create(ownerID, first_name, last_name, phone)
...
class OwnerModelTest(TestCase):
    ...
    def test_owner_instance_was_created(self):
        ...
        new_owner = create_owner('1', 'Hans', 'Eckman', '0101010101')
